...
LIB_RPI=-Wl,--gc-sections  -L/usr/lib/arm-linux-gnueabihf -lX11 -lXext
...
RPI_epd:${OBJ_O}
	echo $(@)
	$(CXX) $(CFLAGS) $(OPENCV_FLAG) -D RPI $(OBJ_O) $(RPI_DEV_C) -o $(TARGET) $(LIB_RPI) $(DEBUG)
...
${DIR_OBJ}/%.o:$(DIR_WP43S)/%.cpp
	$(CXX) $(CFLAGS) -c  $< -o $@ $(OPENCV_FLAG) -I $(DIR_Config) -I $(DIR_GUI) -I $(DIR_EPD) $(DEBUG)
    
${DIR_OBJ}/%.o:$(DIR_EPD)/%.cpp
	$(CXX) $(CFLAGS) -c  $< -o $@ -I $(DIR_Config) $(DEBUG)
    
${DIR_OBJ}/%.o:$(DIR_GUI)/%.cpp
	$(CXX) $(CFLAGS) -c  $< -o $@ -I $(DIR_Config) $(DEBUG)

RPI_DEV:
	$(CXX) $(CFLAGS) $(DEBUG_RPI) -c  $(DIR_Config)/dev_hardware_SPI.cpp -o $(DIR_OBJ)/dev_hardware_SPI.o $(LIB_RPI) $(DEBUG)
	$(CXX) $(CFLAGS) $(DEBUG_RPI) -c  $(DIR_Config)/RPI_sysfs_gpio.cpp -o $(DIR_OBJ)/RPI_sysfs_gpio.o $(LIB_RPI) $(DEBUG)
	$(CXX) $(CFLAGS) $(DEBUG_RPI) -c  $(DIR_Config)/DEV_Config.cpp -o $(DIR_OBJ)/DEV_Config.o $(LIB_RPI) $(DEBUG)
