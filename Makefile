...
LIB_RPI=-Wl,--gc-sections  -L/usr/lib/aarch64-linux-gnu -lX11 -lXext  -lXi
...
CC            = gcc
CXX           = g++
MSG = -std=c++14 -g -O -ffunction-sections -fdata-sections -Wall -lstdc++
CXXFLAGS += $(MSG)
OPENCV_FLAG = -I/usr/include/opencv4 -L/usr/lib/aarch64-linux-gnu
OPENCV_LIB = -lopencv_aruco -lopencv_bgsegm -lopencv_bioinspired -lopencv_calib3d -lopencv_ccalib -lopencv_core -lopencv_datasets -lopencv_dnn_objdetect -lopencv_dnn -lopencv_dpm -lopencv_face -lopencv_features2d -lopencv_flann -lopencv_freetype -lopencv_fuzzy -lopencv_hfs -lopencv_highgui -lopencv_imgcodecs -lopencv_img_hash -lopencv_imgproc -lopencv_line_descriptor -lopencv_ml -lopencv_objdetect -lopencv_optflow -lopencv_phase_unwrapping -lopencv_photo -lopencv_plot -lopencv_quality -lopencv_reg -lopencv_rgbd -lopencv_saliency -lopencv_shape -lopencv_stereo -lopencv_stitching -lopencv_structured_light -lopencv_superres -lopencv_surface_matching -lopencv_text -lopencv_tracking -lopencv_videoio -lopencv_video -lopencv_videostab -lopencv_features2d -lopencv_ximgproc -lopencv_xobjdetect -lopencv_xphoto

RPI_epd:${OBJ_O}
	echo $(@)
	$(CXX) $(CXXFLAGS) $(OPENCV_FLAG) -D RPI $(OBJ_O) $(RPI_DEV_C) $(OPENCV_LIB) -o $(TARGET) $(LIB_RPI) $(DEBUG) -lstdc++fs -lpthread
...
${DIR_OBJ}/%.o:$(DIR_WP43S)/%.cpp
	$(CXX) $(CXXFLAGS) -c  $< -o $@ $(OPENCV_FLAG) $(OPENCV_LIB) -I $(DIR_Config) -I $(DIR_GUI) -I $(DIR_EPD) -I $(DIR_BMP) $(DEBUG)
